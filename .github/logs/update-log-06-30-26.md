### Generated logs from GitHub Action: [28435797033](https://github.com/rajusem/multicluster-observability-operator/actions/runs/28435797033)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20260630013219-bb1af6d11cbd
...
- go: downloading github.com/openshift/hypershift v0.1.78
...
- go: downloading github.com/openshift/api v0.0.0-20260629123346-784126000268
...
- go: downloading github.com/stolostron/observatorium-operator v0.0.0-20260629133503-1b38105f372c
...
- go: downloading github.com/openshift/client-go v0.0.0-20260629081241-b769428f4111
...
- go: downloading github.com/prometheus/alertmanager v0.33.0
...
- go: downloading github.com/openshift/library-go v0.0.0-20260630085645-45679084a74b
...
- go: downloading github.com/zmap/zcrypto v0.0.0-20260605180650-cdd78957abdf
...
- go: downloading github.com/aws/aws-sdk-go-v2/credentials v1.19.25
- go: downloading github.com/aws/aws-sdk-go-v2/config v1.32.26
...
- go: downloading github.com/aws/aws-sdk-go-v2/service/sts v1.43.4
...
- go: downloading github.com/go-openapi/swag/jsonname v0.27.0
...
- go: downloading github.com/go-openapi/analysis v0.25.3
...
- go: downloading github.com/aws/aws-sdk-go-v2/service/sso v1.31.4
- go: downloading cloud.google.com/go/compute/metadata v0.9.0
- go: downloading github.com/aws/aws-sdk-go-v2/service/ssooidc v1.36.7
...
- go: downloading google.golang.org/genproto v0.0.0-20260622175928-b703f567277d
...
- go: github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring@v0.92.1 requires go >= 1.26.0; switching to go1.26.4
...
- go: all: module k8s.io/api@upgrade found (v0.36.2), but does not contain package k8s.io/api/autoscaling/v2beta1
- go: all: module k8s.io/api@upgrade found (v0.36.2), but does not contain package k8s.io/api/autoscaling/v2beta2
- go: all: module k8s.io/api@upgrade found (v0.36.2), but does not contain package k8s.io/api/scheduling/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/applyconfigurations/autoscaling/v2beta1
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/applyconfigurations/autoscaling/v2beta2
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/applyconfigurations/scheduling/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/informers/autoscaling/v2beta1
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/informers/autoscaling/v2beta2
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/informers/scheduling/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/kubernetes/typed/autoscaling/v2beta1
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/kubernetes/typed/autoscaling/v2beta1/fake
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/kubernetes/typed/autoscaling/v2beta2
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/kubernetes/typed/autoscaling/v2beta2/fake
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/kubernetes/typed/scheduling/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/kubernetes/typed/scheduling/v1alpha1/fake
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/listers/autoscaling/v2beta1
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/listers/autoscaling/v2beta2
- go: all: module k8s.io/client-go@upgrade found (v0.36.2), but does not contain package k8s.io/client-go/listers/scheduling/v1alpha1
