### Generated logs from GitHub Action: [22752799900](https://github.com/rajusem/multicluster-observability-operator/actions/runs/22752799900)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20260305234351-ffb454647366
...
- go: downloading github.com/openshift/api v0.0.0-20260306002634-d3bbdada155c
...
- go: downloading github.com/openshift/client-go v0.0.0-20260305174943-67b007d67537
...
- go: downloading github.com/openshift/library-go v0.0.0-20260303171201-5d9eb6295ff6
...
- go: downloading cloud.google.com/go/compute v1.56.0
...
- go: downloading go.opentelemetry.io/contrib/propagators/autoprop v0.66.0
- go: downloading go.opentelemetry.io/otel/bridge/opentracing v1.41.0
- go: downloading go.opentelemetry.io/contrib v1.41.0
...
- go: downloading go.opentelemetry.io/contrib/propagators/aws v1.41.0
...
- go: downloading go.opentelemetry.io/contrib/propagators/ot v1.41.0
...
- go: github.com/openshift/hypershift/api@v0.0.0-20260305234351-ffb454647366 requires go >= 1.25.3; switching to go1.25.8
...
- go: all: module go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp@upgrade found (v0.66.0), but does not contain package go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp/internal/semconvutil
- go: all: module go.opentelemetry.io/otel/sdk@upgrade found (v1.41.0), but does not contain package go.opentelemetry.io/otel/sdk/internal/env
