### Generated logs from GitHub Action: [29991867756](https://github.com/rajusem/multicluster-observability-operator/actions/runs/29991867756)
...
- go: downloading github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.92.1
- go: downloading github.com/prometheus/client_model v0.6.2
- go: downloading github.com/prometheus-operator/prometheus-operator v0.92.1
- go: downloading github.com/prometheus/prometheus v0.313.1
- go: downloading github.com/prometheus/client_golang v1.23.2
- go: downloading github.com/openshift/hypershift/api v0.0.0-20241119231618-9aca80837541
- go: downloading github.com/prometheus/client_golang v1.24.0
- go: downloading github.com/prometheus/common v0.68.0
- go: downloading github.com/prometheus/common v0.70.1
- go: downloading github.com/openshift/hypershift/api v0.0.0-20260723012626-b5f390612d5a
...
- go: downloading github.com/openshift/hypershift v0.1.79
...
- go: downloading github.com/stolostron/controller-filtered-cache v0.0.0-20260616160842-d4400ae7d765
...
- go: downloading github.com/openshift/api v0.0.0-20260722154127-581cfdf71986
...
- go: downloading open-cluster-management.io/governance-policy-propagator v0.19.0
...
- go: downloading open-cluster-management.io/config-policy-controller v0.19.0
- go: downloading github.com/stolostron/observatorium-operator v0.0.0-20260715135030-1d202794235d
- go: downloading github.com/google/go-cmp v0.7.0
- go: downloading github.com/openshift/client-go v0.0.0-20260721124015-35d8f3c0e847
...
- go: downloading github.com/prometheus-operator/prometheus-operator/pkg/client v0.92.1
...
- go: downloading github.com/thanos-io/thanos v0.42.2
- go: downloading google.golang.org/protobuf v1.36.11
- go: downloading github.com/prometheus/alertmanager v0.33.1
...
- go: downloading github.com/openshift/library-go v0.0.0-20260722141911-d8f45c2a4f64
...
- go: downloading github.com/zmap/zcrypto v0.0.0-20260716192702-66a5ac2578f3
...
- go: downloading github.com/go-openapi/strfmt v0.27.0
- go: downloading github.com/go-openapi/swag v0.27.3
- go: downloading github.com/modern-go/concurrent v0.0.0-20180306012644-bacd9c7ef1dd
- go: downloading github.com/modern-go/reflect2 v1.0.3-0.20250322232337-35a7c28c31ee
- go: downloading github.com/go-openapi/validate v0.26.1
...
- go: downloading github.com/go-openapi/swag/cmdutils v0.27.3
- go: downloading github.com/go-openapi/swag/conv v0.26.0
- go: downloading github.com/go-openapi/swag/fileutils v0.26.0
- go: downloading github.com/go-openapi/swag/conv v0.27.3
- go: downloading github.com/go-openapi/swag/fileutils v0.27.3
...
- go: downloading github.com/go-openapi/swag/jsonname v0.27.3
- go: downloading github.com/go-openapi/swag/jsonutils v0.27.3
- go: downloading github.com/go-openapi/swag/loading v0.26.0
- go: downloading github.com/go-openapi/swag/mangling v0.26.0
- go: downloading github.com/go-openapi/swag/loading v0.27.3
- go: downloading github.com/go-openapi/swag/netutils v0.26.0
- go: downloading github.com/go-openapi/swag/mangling v0.27.3
- go: downloading github.com/go-openapi/swag/stringutils v0.26.0
- go: downloading github.com/go-openapi/swag/netutils v0.27.3
- go: downloading github.com/go-openapi/swag/typeutils v0.26.0
- go: downloading github.com/go-openapi/swag/stringutils v0.27.3
- go: downloading github.com/go-openapi/swag/yamlutils v0.26.0
- go: downloading github.com/go-openapi/swag/typeutils v0.27.3
- go: downloading github.com/dennwc/varint v1.0.0
- go: downloading github.com/go-openapi/swag/yamlutils v0.27.3
...
- go: downloading github.com/go-openapi/analysis v0.25.5
- go: downloading github.com/go-openapi/spec v0.21.0
- go: downloading github.com/go-openapi/loads v0.25.0
- go: downloading github.com/go-openapi/spec v0.22.9
...
- go: downloading cloud.google.com/go/compute v1.65.0
...
- go: downloading github.com/tjhop/slog-gokit v0.2.1
...
- go: downloading github.com/google/pprof v0.0.0-20260709232956-b9395ee17fa0
...
- go: downloading google.golang.org/genproto v0.0.0-20260720211330-0afa2a65878a
...
- go: github.com/openshift/api@v0.0.0-20260722154127-581cfdf71986 requires go >= 1.26.0; switching to go1.26.5
- go: downloading go1.26.5 (linux/amd64)
- go: all: module cloud.google.com/go/auth@upgrade found (v0.22.0), but does not contain package cloud.google.com/go/auth/internal/trustboundary
- go: all: module github.com/prometheus/prometheus@upgrade found (v0.313.1), but does not contain package github.com/prometheus/prometheus/tsdb/errors
- go: all: module google.golang.org/grpc@upgrade found (v1.82.1), but does not contain package google.golang.org/grpc/internal/balancer/weight
- go: all: module k8s.io/api@upgrade found (v0.36.3), but does not contain package k8s.io/api/autoscaling/v2beta1
- go: all: module k8s.io/api@upgrade found (v0.36.3), but does not contain package k8s.io/api/autoscaling/v2beta2
- go: all: module k8s.io/api@upgrade found (v0.36.3), but does not contain package k8s.io/api/scheduling/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/applyconfigurations/autoscaling/v2beta1
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/applyconfigurations/autoscaling/v2beta2
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/applyconfigurations/scheduling/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/informers/autoscaling/v2beta1
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/informers/autoscaling/v2beta2
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/informers/scheduling/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/kubernetes/typed/autoscaling/v2beta1
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/kubernetes/typed/autoscaling/v2beta1/fake
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/kubernetes/typed/autoscaling/v2beta2
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/kubernetes/typed/autoscaling/v2beta2/fake
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/kubernetes/typed/scheduling/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/kubernetes/typed/scheduling/v1alpha1/fake
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/listers/autoscaling/v2beta1
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/listers/autoscaling/v2beta2
- go: all: module k8s.io/client-go@upgrade found (v0.36.3), but does not contain package k8s.io/client-go/listers/scheduling/v1alpha1
