### Generated logs from GitHub Action: [23785576654](https://github.com/rajusem/multicluster-observability-operator/actions/runs/23785576654)
...
- go: downloading github.com/prometheus-operator/prometheus-operator v0.90.1
- go: downloading github.com/openshift/hypershift/api v0.0.0-20241119231618-9aca80837541
- go: downloading github.com/openshift/hypershift/api v0.0.0-20260331012837-6f289aba25b8
...
- go: downloading github.com/openshift/api v0.0.0-20260330162214-96f1f5ac7ff2
...
- go: downloading github.com/stolostron/observatorium-operator v0.0.0-20260323093333-a33b44f49762
...
- go: downloading github.com/openshift/client-go v0.0.0-20260330134249-7e1499aaacd7
...
- go: downloading github.com/prometheus-operator/prometheus-operator/pkg/client v0.90.1
...
- go: downloading github.com/openshift/library-go v0.0.0-20260326200317-12d8376369b7
- go: downloading k8s.io/apiserver v0.35.3
- go: downloading k8s.io/kube-aggregator v0.33.2
- go: downloading k8s.io/kube-aggregator v0.35.3
...
- go: downloading google.golang.org/api v0.273.0
...
- go: downloading google.golang.org/genproto v0.0.0-20260330182312-d5a96adf58d8
...
- go: downloading github.com/googleapis/gax-go/v2 v2.20.0
...
- go: github.com/openshift/hypershift/api@v0.0.0-20260331012837-6f289aba25b8 requires go >= 1.25.3; switching to go1.25.8
...
- go: all: module k8s.io/api@upgrade found (v0.35.3), but does not contain package k8s.io/api/networking/v1alpha1
- go: all: module k8s.io/api@upgrade found (v0.35.3), but does not contain package k8s.io/api/storagemigration/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.35.3), but does not contain package k8s.io/client-go/applyconfigurations/networking/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.35.3), but does not contain package k8s.io/client-go/applyconfigurations/storagemigration/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.35.3), but does not contain package k8s.io/client-go/informers/networking/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.35.3), but does not contain package k8s.io/client-go/informers/storagemigration/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.35.3), but does not contain package k8s.io/client-go/kubernetes/typed/networking/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.35.3), but does not contain package k8s.io/client-go/kubernetes/typed/networking/v1alpha1/fake
- go: all: module k8s.io/client-go@upgrade found (v0.35.3), but does not contain package k8s.io/client-go/kubernetes/typed/storagemigration/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.35.3), but does not contain package k8s.io/client-go/kubernetes/typed/storagemigration/v1alpha1/fake
- go: all: module k8s.io/client-go@upgrade found (v0.35.3), but does not contain package k8s.io/client-go/listers/networking/v1alpha1
- go: all: module k8s.io/client-go@upgrade found (v0.35.3), but does not contain package k8s.io/client-go/listers/storagemigration/v1alpha1
