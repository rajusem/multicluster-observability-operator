...
// Note: CreateOrUpdatePrometheusRulePolicy is a thin wrapper around rsutility.CreateOrUpdateRSPrometheusRulePolicy
...
func TestCreateOrUpdatePrometheusRulePolicy_UsesCorrectConstants(t *testing.T) {
	...
	err := nm.CreateOrUpdatePrometheusRulePolicy(context.TODO(), rule)
	...
	assert.Equal(t, nm.State.Namespace, created.Namespace, "Should use Namespace variable")
