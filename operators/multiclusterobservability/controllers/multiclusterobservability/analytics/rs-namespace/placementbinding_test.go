...
// Note: CreatePlacementBinding is a thin wrapper around rsutility.CreateRSPlacementBinding
...
func TestCreatePlacementBinding_UsesCorrectConstants(t *testing.T) {
	...
	assert.Equal(t, nm.State.Namespace, pb.Namespace, "Should use Namespace variable")
